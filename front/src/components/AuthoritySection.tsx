...
export const AuthoritySection = () => {
  ...
  // Helper para convertir kebab-case o lowercase a PascalCase
      ...
      <div className="container relative z-10 px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            No prometemos riquezas instantáneas. Ofrecemos educación seria,
            metodología probada y acompañamiento profesional. Los resultados
            hablan por sí solos.
          </p>
        </div>
          ...
          {credentials.map((credential) => {
            const Icon =
              (
                ...
                >
              )[toPascalCase(credential.icon)] || LucideIcons.HelpCircle;
          ...
          <div className="flex flex-col md:flex-row items-start gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                El trading en mercados financieros conlleva riesgos
                significativos y puede no ser adecuado para todos los
                inversores. Los resultados pasados no garantizan rendimientos
                futuros. Nunca inviertas dinero que no puedas permitirte perder.
                Este programa es educativo y no constituye asesoría financiera.
                Consulta con un profesional antes de tomar decisiones de
                inversión.
              </p>
            </div>
          </div>
