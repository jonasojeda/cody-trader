 ...
 * MedioPago
 *
 * Controlador para gestionar los medios de pago.
 */
class MedioPagoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = MedioPago::when($ordenFechaCreado, function ($query) use ($ordenFechaCreado) {
    ...
    {
        return response()->json($medioPago->obtenerDatos(), 200);
    }
