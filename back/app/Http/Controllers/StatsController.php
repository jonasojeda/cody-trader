 ...
 * Stats
 *
 * Controlador para gestionar las estadísticas.
 */
class StatsController extends Controller
{
     ...
     *
     * Obtener listado de estadísticas.
     *
    ...
    public function index(Request $request)
    {
        ...
        $query = Stats::when($ordenFechaCreado, function ($query) use ($ordenFechaCreado) {
     ...
     *
     * Obtener datos de una estadística.
     *
     * @urlParam stat int required ID de la estadística. Example: 1
     */
    public function show(Stats $stat)
    {
        return response()->json($stat->obtenerDatos(), 200);
    }
}
