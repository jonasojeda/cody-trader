import { Target, ShieldCheck, LineChart, Brain, Calculator } from "lucide-react";
      ...
      <div className="container relative z-10 px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/10 border border-secondary/20 mb-6">
            ...
            <span className="text-sm text-secondary font-medium">Metodología</span>
          </div>
          
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold mb-6">
            Un enfoque{" "}
            <span className="text-gradient-trust">sistemático</span>{" "}
            y medible
          </h2>
          
          <p className="text-lg text-muted-foreground">
            Nuestra metodología se basa en principios probados de gestión de riesgo, 
            análisis técnico y psicología del trading. Todo documentado, todo verificable.
          </p>
        </div>
        ...
        <div className="mt-16 card-elevated rounded-2xl p-8 border border-border/50">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <p className="text-4xl md:text-5xl font-display font-bold text-primary mb-2">340+</p>
              <p className="text-muted-foreground">Operaciones backtested</p>
            </div>
            <div className="text-center">
              <p className="text-4xl md:text-5xl font-display font-bold text-secondary mb-2">87%</p>
              <p className="text-muted-foreground">Tasa de acierto</p>
            </div>
            <div className="text-center">
              <p className="text-4xl md:text-5xl font-display font-bold text-foreground mb-2">1:3</p>
              <p className="text-muted-foreground">Ratio riesgo/beneficio</p>
            </div>
            <div className="text-center">
              <p className="text-4xl md:text-5xl font-display font-bold text-primary mb-2">2%</p>
