      ...
      <div className="container relative z-10 px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold mb-6">
            Aprende de{" "}
            <span className="text-gradient-trust">profesionales</span>{" "}
            reales
          </h2>
          
          <p className="text-lg text-muted-foreground">
            Nuestros instructores son traders activos con años de experiencia documentada 
            en mercados financieros. Sin teoría vacía, solo conocimiento aplicado.
          </p>
        </div>
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute top-4 right-4 px-3 py-1.5 rounded-full bg-background/80 backdrop-blur-sm border border-border/50">
                  <span className="text-xs font-medium text-primary">{instructor.experience}</span>
                </div>
              </div>
              ...
              <div className="p-6">
                <div className="mb-4">
                  ...
                  <p className="text-secondary text-sm font-medium">{instructor.role}</p>
                </div>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="text-center p-6 rounded-xl bg-muted/30 border border-border/30">
            <p className="text-3xl font-display font-bold text-foreground mb-1">30+</p>
            <p className="text-sm text-muted-foreground">Años combinados</p>
          </div>
          <div className="text-center p-6 rounded-xl bg-muted/30 border border-border/30">
            <p className="text-3xl font-display font-bold text-secondary mb-1">3</p>
            <p className="text-sm text-muted-foreground">Mentores activos</p>
          </div>
          <div className="text-center p-6 rounded-xl bg-muted/30 border border-border/30">
            <p className="text-3xl font-display font-bold text-primary mb-1">100%</p>
